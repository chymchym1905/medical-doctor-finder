...
$database = new DatabaseClass(db_name:"mdfinder", table_name:"apointment");
?>
...
<head>
    ...
    <title>Admin Edits Appointment</title>
    <!-- Font -->
...
<?php $ap_id = $_GET['ap-id'];?>
<?php  $ap = $database->getUser($ap_id);?>
<?php $row = mysqli_fetch_assoc($ap);?>
